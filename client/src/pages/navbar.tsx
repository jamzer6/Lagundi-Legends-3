  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0">
            <Link to="/" className="group relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-green-100 to-green-600 rounded-lg blur opacity-25 group-hover:opacity-75 transition duration-1000 group-hover:duration-200"></div>
              <img
      ...
      {isScrolled && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-3 right-8 p-4 bg-green-800/80 backdrop-blur-sm text-white rounded-full shadow-lg hover:bg-green-700 transition-all duration-300 transform hover:scale-110 group"
        >
